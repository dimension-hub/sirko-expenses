document.addEventListener('DOMContentLoaded', () => {
  ...
  // 3) ПЕРЕМИКАННЯ СЕКЦІЙ із SKELETON & FADE-IN
  const tabs = {
  ...
  Object.entries(tabs).forEach(([btnId, secId]) => {
    ...
    btn.addEventListener('click', () => {
      ...
      // Якщо це ДАШБОРД — просто показати
      if (secId === 'dashboard') {
      ...
      // Інакше — скелетони → контент із fadeIn
